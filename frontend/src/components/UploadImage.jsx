...
const UploadImage = () => {
  ...
  return (
    <div className="max-w-md mx-auto my-8 p-6 bg-red-100 shadow-md rounded-md">
      <h1 className="text-2xl font-semibold mb-4 text-gray-800">Upload Images</h1>

      <div>
        <label className="relative cursor-pointer bg-pink-300 hover:bg-pink-400 text-white py-2 px-4 rounded-md w-full text-center inline-block">
          Choose Image
